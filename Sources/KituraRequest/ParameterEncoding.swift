...
/*public enum ParameterEncoding {
    ...
    private func encodeInURL(request: inout URLRequest, parameters: [[String: Any]]) throws {
    ...
    private func encodeInJSON(request: inout URLRequest, parameters: [[String: Any]]) throws {
    ...
    private func encodeInMultipart(request: inout URLRequest, parameters: [[String: Any]]) throws {
